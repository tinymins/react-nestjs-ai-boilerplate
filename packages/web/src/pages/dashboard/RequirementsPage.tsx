  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {[
          {
            titleKey: "dashboard.requirements.toAnalyze",
            count: 12,
            color:
              "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300",
          },
          {
            titleKey: "dashboard.requirements.inDesign",
            count: 8,
            color:
              "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
          },
          {
            titleKey: "dashboard.requirements.completed",
            count: 45,
            color:
      ...
      <div className="card">
        <h3 className="text-lg font-semibold mb-4">
          {t("dashboard.requirements.recentRequirements")}
        </h3>
        <div className="space-y-3">
          {[
            {
              id: "REQ-1024",
              titleKey: "dashboard.requirements.sampleTitle1",
              statusKey: "dashboard.requirements.toAnalyze",
            },
            {
              id: "REQ-1023",
              titleKey: "dashboard.requirements.sampleTitle2",
              statusKey: "dashboard.requirements.inDesign",
            },
            {
              id: "REQ-1022",
              titleKey: "dashboard.requirements.sampleTitle3",
              statusKey: "dashboard.requirements.completed",
            },
          ].map((req) => (
            <div
              key={req.id}
