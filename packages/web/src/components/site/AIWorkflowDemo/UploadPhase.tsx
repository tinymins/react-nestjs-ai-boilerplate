      ...
      <div className="w-full max-w-lg">
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-200">{t("aiWorkflow.upload.title")}</h3>
            <p className="mt-3 text-slate-500 dark:text-slate-400">{t("aiWorkflow.upload.desc")}</p>
            <div className="mt-2 flex flex-wrap justify-center gap-2 text-xs text-slate-400">
              <span className="rounded bg-slate-100 px-2 py-1 dark:bg-slate-800">PDF</span>
              <span className="rounded bg-slate-100 px-2 py-1 dark:bg-slate-800">Word</span>
              <span className="rounded bg-slate-100 px-2 py-1 dark:bg-slate-800">Markdown</span>
              <span className="rounded bg-slate-100 px-2 py-1 dark:bg-slate-800">Excel</span>
            </div>
            <motion.button
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-red-500/10 text-2xl">📕</div>
            <div className="flex-1">
              <p className="font-medium text-slate-700 dark:text-slate-300">{t("aiWorkflow.upload.sampleFile")}</p>
              <p className="text-sm text-slate-400">{t("aiWorkflow.upload.sampleMeta")}</p>
            </div>
            <motion.div
              animate={{ rotate: 360 }}
