/**
 * Icon components for WeChat Mini Program.
 *
 * lucide-react renders <svg> elements which are not valid in WXML and cause
 * "Template tmpl_0_svg not found" errors. Instead, we render each icon as
 * an <Image> with an inline SVG data URI — WeChat supports this since lib 2.3.
 *
 * SVG paths sourced from lucide-react v0.447.0 (ISC licence).
 */
...
function makeIcon(inner: string) {
  return function Icon({ size = 24, color = "#000000" }: IconProps) {
...
export const Package2 = makeIcon(
