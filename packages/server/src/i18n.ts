...
export type Language = "zh-CN" | "zh-TW" | "en-US" | "ja-JP" | "de-DE" | "lzh" | "wuu" | "hak" | "yue";
...
export const normalizeLanguage = (value?: string): Language => {
	...
	// Cantonese
	if (lower === "yue" || lower.startsWith("zh-yue") || lower === "zh-hk" || lower === "zh-mo") return "yue";
	// Traditional Chinese
...
export const t = (language: Language, key: string): string => {
	const root = resources[language]?.translation ?? resources["zh-CN"].translation;
